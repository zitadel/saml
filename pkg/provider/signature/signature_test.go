...
func TestSignature_ValidatePost(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "crewjam",
			args: args{
				authRequest: "<samlp:AuthnRequest xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\" xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" ID=\"id-208ffcd9e81b458cdecdb13e5ed47ae8784f7562\" Version=\"2.0\" IssueInstant=\"2023-04-06T08:12:59.812Z\" Destination=\"http://localhost:8080/saml/v2/SSO\" AssertionConsumerServiceURL=\"http://localhost:8000/saml/acs\" ProtocolBinding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\"><saml:Issuer Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:entity\">http://localhost:8000/saml/metadata</saml:Issuer><ds:Signature xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:SignedInfo><ds:CanonicalizationMethod Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><ds:SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><ds:Reference URI=\"#id-208ffcd9e81b458cdecdb13e5ed47ae8784f7562\"><ds:Transforms><ds:Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/><ds:Transform Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></ds:Transforms><ds:DigestMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><ds:DigestValue>SccDsJHhR/LtF3nlFb4JqTttZXs=</ds:DigestValue></ds:Reference></ds:SignedInfo><ds:SignatureValue></ds:SignatureValue><ds:KeyInfo><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo></ds:Signature><samlp:NameIDPolicy Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:transient\" AllowCreate=\"true\"/></samlp:AuthnRequest>",
				certificate: "",
			},
			err: false,
		},
		{
...
func TestSignature_CreatePost(t *testing.T) {
	...
	blockCaCertGen, _ := pem.Decode(caCertGen)
	if blockCaCertGen == nil || blockCaCertGen.Type != "CERTIFICATE" {
		t.Error("Create() failed to decode ca cert")
		return
	}
	keyGen, certGen, err := newCertAndKey(caKeyGen, blockCaCertGen.Bytes)
	if err != nil {
		t.Error("Create() failed to create cert")
		return
	}
	blockCertGen, _ := pem.Decode(certGen)
	if blockCertGen == nil || blockCertGen.Type != "CERTIFICATE" {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, signer, err := signature.GetSigningContextAndSigner(blockCertGen.Bytes, keyGen, tt.args.singatureAlgorithm)
			if err != nil {
				if (err != nil) != tt.res.err {
...
func newCertAndKey(
	...
	caCert, err := x509.ParseCertificate(caCertificate)
	if err != nil {
		return nil, nil, err
	}

	certBytes, err := x509.CreateCertificate(cryptorand.Reader, cert, caCert, &certPrivKey.PublicKey, caPrivateKey)
	if err != nil {
		return nil, nil, err
	}
	...
	return certPrivKey, certPem.Bytes(), nil
}
...
func newCACertAndKey() (
	*rsa.PrivateKey,
	...
	return caPrivKey, caCertPem.Bytes(), nil
}
